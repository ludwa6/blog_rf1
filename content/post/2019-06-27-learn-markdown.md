...
slug: learn-markdown
---
Between Markdown and RMarkdown -and Pandoc and CommonMark and all the site-specific flavors: GitHub, StackExchange, reddit, etc. - i am really confused as to which to learn.  The starting point, it seems to me, should be the highest COMMON denominator -which, given all these variants, is probably a pretty small set, i reckon (Gruber's maybe?)  Anyway: I post below the Help file from MacDown, the desktop tool i find handiest for testing my markdown; let's compare how Hugo parses this with how MacDown does, and see if there's anything to worry about here.
